...
input_frame = Frame(win, width=312, height=50, bd=0, highlightbackground="grey", highlightcolor="green", highlightthickness=2)
...
clear = Button(button_fr, text="C", fg="green", width=32, height=3, bd=0, bg="white", cursor="hand2", command=lambda: bt_clear()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)
divide = Button(button_fr, text="/", fg="green", width=10, height=3, bd=0, bg="white", cursor="hand2", command=lambda: btn_click("/")).grid(row=0, column=3, padx=1, pady=1)
seven = Button(button_fr, text="7", fg="green", width=10, height=3, bd=0, bg="yellow", cursor="hand2", command=lambda: btn_click(7)).grid(row=1, column=0, padx=1, pady=1)
eight = Button(button_fr, text="8", fg="green", width=10, height=3, bd=0, bg="red", cursor="hand2", command=lambda: btn_click(8)).grid(row=1, column=1, padx=1, pady=1)
nine = Button(button_fr, text="9", fg="green", width=10, height=3, bd=0, bg="pink", cursor="hand2", command=lambda: btn_click(9)).grid(row=1, column=2, padx=1, pady=1)
multiply = Button(button_fr, text="*", fg="green", width=10, height=3, bd=0, bg="brown", cursor="hand2", command=lambda: btn_click("*")).grid(row=1, column=3, padx=1, pady=1)
